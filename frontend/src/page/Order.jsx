...
import { Apple, Cake, CupSoda, Salad } from 'lucide-react';
...
const Order = () => {
    ...
    const arr = [<Apple size={"18px"} color='#343434' />, <Salad size={"18px"} color='#343434' />, <CupSoda size={"18px"} color='#343434' />, <Cake size={"18px"} color='#343434' />, <Apple size={"18px"} color='#343434' />, <Apple size={"18px"} color='#343434' />, <Apple size={"18px"} color='#343434' />, <Apple size={"18px"} color='#343434' />]
    function getTotal() {
        let sum = 0;
                            ...
                            <Box className='heading' w={"90%"} m={"auto"}>
                                ...
                                <Flex alignItems={"center"} justifyContent={"space-between"}>
                                    ...
                                    <Flex gap={"20px"}>
                                        ...
                                        <Button colorScheme='green' bgColor={"#006839"} borderRadius={"full"} px={"20px"} size={"sm"}>Approve Order</Button>
                                    </Flex>
                                </Flex>
                            </Box>
                        </Box>
